...
(function (window, document, Math) {
    ...
    for (var key in options) {
      switch (key) {
        ...
        case "theme":
          picker.setAttribute(
            "class",
            "clr-picker clr-" + options.theme.split("-").join(" clr-")
          );
          break;
        case "margin":
          options.margin *= 1;
  ...
  function init() {
    ...
    picker.innerHTML =
      ...
      "</div>" +
      '<div class="clr-hue">' +
      ('<input id="clr-hue-slider" type="range" min="0" max="360" step="1" aria-label="' +
        settings.a11y.hueSlider +
        '">') +
      '<div id="clr-hue-marker"></div>' +
      "</div>" +
      '<div class="clr-alpha">' +
      ('<input id="clr-alpha-slider" type="range" min="0" max="100" step="1" aria-label="' +
      ...
      ('<button id="clr-color-preview" class="clr-preview" aria-label="' +
        settings.a11y.close +
        '"></button>') +
